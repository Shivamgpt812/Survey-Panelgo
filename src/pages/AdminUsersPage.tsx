...
const AdminUsersPage: React.FC = () => {
  ...
  useEffect(() => {
    if (!token) return;
    void apiGet<{ users: FullUser[] }>('/api/users', token)
    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-periwinkle">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8">
          <div>
            <h1 className="font-outfit font-bold text-3xl sm:text-4xl text-navy flex items-center gap-3">
              Registered Users & Panelists
            </h1>
            <p className="font-jakarta text-navy-light mt-1">
              View and manage complete profile records, demographics, professional roles, panel affiliations, and rewards points.
            </p>
          </div>
        </div>

        {/* Filters & Search Toolbar */}
        <PlayfulCard className="p-4 sm:p-5 mb-8">
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-20">
            <div className="w-12 h-12 border-4 border-violet border-t-transparent rounded-full animate-spin mb-4" />
        ...
        {!loading && filteredUsers.length === 0 && (
          <PlayfulCard className="p-12 text-center">
            ...
            <p className="font-jakarta text-navy-light max-w-md mx-auto mb-6 text-sm">
                    ...
                    <div>
                      ...
                      <div className="flex items-start justify-between gap-3 mb-3">
                        <div className="flex items-center gap-3 min-w-0">
                          <div className={`w-11 h-11 rounded-2xl border-2 border-navy flex items-center justify-center font-outfit font-bold text-lg shrink-0 ${
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-navy/40 backdrop-blur-sm animate-fade-in">
            ...
            >
              ...
              <div className="p-6 bg-gradient-to-r from-violet/10 via-pink/10 to-yellow/10 border-b-2 border-navy/10 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className={`w-12 h-12 rounded-2xl border-2 border-navy flex items-center justify-center font-outfit font-bold text-xl ${
